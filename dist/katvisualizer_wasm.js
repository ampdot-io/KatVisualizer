...
function __wasm_bindgen_func_elem_320(arg0, arg1, arg2) {
    wasm.__wasm_bindgen_func_elem_320(arg0, arg1, addHeapObject(arg2));
}

function __wasm_bindgen_func_elem_818(arg0, arg1) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.__wasm_bindgen_func_elem_818(retptr, arg0, arg1);
...
const WebVisualizerFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_webvisualizer_free(ptr >>> 0, 1));

export class WebVisualizer {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WebVisualizerFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_webvisualizer_free(ptr, 0);
    }
}
if (Symbol.dispose) WebVisualizer.prototype[Symbol.dispose] = WebVisualizer.prototype.free;
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_stop_1f7f7127a94a346f = function() { return handleError(function (arg0) {
        getObject(arg0).stop();
    }, arguments) };
    ...
    imports.wbg.__wbindgen_cast_32bc49bfb4050e32 = function(arg0, arg1) {
        ...
        const ret = makeMutClosure(arg0, arg1, wasm.__wasm_bindgen_func_elem_319, __wasm_bindgen_func_elem_320);
        return addHeapObject(ret);
    };
    ...
    imports.wbg.__wbindgen_cast_6649939ec9edf1a5 = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 1, function: Function { arguments: [], shim_idx: 59, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, wasm.__wasm_bindgen_func_elem_319, __wasm_bindgen_func_elem_818);
        return addHeapObject(ret);
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('katvisualizer_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
